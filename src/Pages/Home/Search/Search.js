...
const Search = () => {
    return (
        <div className='w-96 mx-auto mt-28'>
            <h1 className='text-2xl font-bold text-center mb-8'>Find your desired flight</h1>
            <form className="flex items-center">
                ...
                <button type="submit" className="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-deepViolet rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
