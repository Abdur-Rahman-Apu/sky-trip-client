...
const Benefit = () => {
    return (
        <div className='flex flex-col md:flex-row justify-center items-center my-24 px-14 h-[400px]'>
            ...
            <div className='basis-1/2 benefit-img relative flex justify-center'>
                ...
                <div className='rounded-full w-40 h-[250px] absolute top-32 right-24'>
