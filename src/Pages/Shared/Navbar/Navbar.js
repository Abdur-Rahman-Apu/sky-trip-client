    ...
    <>
      ...
      <li>
        <Link
          to="/flight"
          className={`${
            location.pathname?.toLowerCase().includes("flight") ? "active" : ""
          }`}
        >
          Flight
        </Link>
      ...
      <div className="navbar-end">
        ...
        <div className="mr-2">
          {theme === "dark" ? (
            ...
            >
              <svg
                className="fill-current w-7 md:w-9 md:h-9"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
        ...
        {user ? (
          <>
            <button
              ...
              className="btn btn-sm md:btn-md text-xs rounded-full border-0 bg-deepViolet"
            >
              Log out
            </button>
          </>
